...
import {
  ...
  projectFinalCost,
  detectCategory
} from '../../services/agents/financialIntelligenceAgent';
...
describe('Financial Intelligence Agent', () => {
  ...
  describe('Integration Test - Full Financial Flow', () => {
    test('should track expenses and provide budget insights', () => {
      ...
      budget.invitations.spent = 200; // Only $200 spent out of $600 allocated
      ...
      // Invitations should be flagged for decrease (over-allocated, under-spent)
